                ...
                children: [
                  Padding(
                    padding: EdgeInsets.only(
                        left: Intl.getCurrentLocale() == 'en' ? 0.w : 210.w),
                    child: TextFieldLabel(textField: S.of(context).emailAdress),
                  ),
                  SettingTextField(
                  ...
                  Padding(
                    ...
                    child: TextFieldLabel(textField: S.of(context).password),
                  ),
                  SettingTextField(
                ...
                if (_formKey.currentState!.validate()) {
                  try {
                    ...
                    if (e.code == 'wrong-password') {
                      ...
                      errorMessage = 'المستخدم لا يتطابق مع بيانات الاعتماد.';
